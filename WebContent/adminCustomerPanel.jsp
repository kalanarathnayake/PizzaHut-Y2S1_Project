  ...
  <tr>
                    ...
                    <th>Delete</th>
	 				...
	 				<%
						  ...
						  ArrayList<Customer> arrayList = customerServices.getCustomerList();
					...
					%>
                        	...
                        	<td><a href="editCustomerDetails.jsp?customerEmail=<%= customer.getEmail()  %>"><button>Edit</button></a></td>
                            <td><a href="deleteCustomer?email=<%= customer.getEmail()  %>"><button>Delete</button></a></td>
                            </tr>
