...
<%@page import="com.pizza.services.FeedbackServicesinterface"%>
<%@page import="com.pizza.services.FeedbackServices"%>
<%@page import="com.pizza.model.Feedback"%>
<%
...
<center><h3>Feedback Details<h3></center>
<div>
  ...
  <tr>
                    ...
                    <th>Delete</th>
	 				...
	 				<%
	 					  ...
	 					  FeedbackServicesinterface feedbackServices = new FeedbackServices();
						  ArrayList<Feedback> arrayList = feedbackServices.getFeedbackList();
					...
					%>
                            ...
                            <td><a href="deleteFeedbackAdmin?feedbackID=<%=feedback.getFeedbackID() %>"><button>Delete</button></a></td>
                            </tr>
