...
<%@page import="com.pizza.services.OrderServicesInterface"%>
<%@page import="com.pizza.services.OrderServices"%>
  ...
  <tr>
                    ...
                    <th>Delete</th>
	 				...
	 				<%
	 					  ...
	 					  OrderServicesInterface orderServices = new OrderServices();
						  ArrayList<Order> arrayList = orderServices.getOrderDetails();
					...
					%>
                            ...
                            <td><a href="deleteOrderAdmin?orderID=<%=order.getOrderID() %>"><button>Delete</button></a></td>
                            </tr>
