    ...
    <section class="ftco-section">
    	...
    	<div class="container">
    		...
    		<div class="row">
    		    ...
    		    <!--Signup form-->
				<form action="insertIntoCart" method="post" enctype='multipart/form-data' style="border:1px solid #ccc">
  				<div class="container">
				...
				<label for="firstName"><b>Pizza ID</b></label>
    			<input type="text" value="<%= pizza.getPizzaID() %>" name="pizzaID" readonly required>

    			<label for="lastName"><b>Pizza Name</b></label>
    			<input type="text" value="<%= pizza.getName() %>" name="pizzaName" readonly required>

   				<label for="password"><b>Price</b></label>
    			<input type="text" value="<%= pizza.getPrice() %>" name="price" readonly required>

  				<input type="hidden" value="<%= pizza.getFileName() %>" name="fileName" readonly required>
