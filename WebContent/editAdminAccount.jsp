    ...
    <section class="ftco-section">
    	...
    	<div class="container">
    		...
    		<div class="row">
    		    ...
    		    <!--Signup form-->
				<form action="updateAdmin" method="post" enctype='multipart/form-data' style="border:1px solid #ccc">
  				<div class="container">
    			...
    			<input type="text" value="<%= admin.getEmail() %>" name="email" readonly required><br>
    			
				<label for="firstName"><b>First Name</b></label>
    			<input type="text" value="<%= admin.getFirstName() %>" name="firstName" required>

    			<label for="lastName"><b>Last Name</b></label>
    			<input type="text" value="<%= admin.getLastName() %>" name="lastName" required>

   				<label for="password"><b>Password</b></label>
    			<input type="text" value="<%= admin.getPassword() %>" name="password" required>

  				<label for="creditCartNumber"><b>Credit Card Number</b></label>
    			<input type="text" value="<%= admin.getAddress() %>" name="address" required>

    			<label for="Address"><b>Address</b></label>
    			<input type="text" value="<%= admin.getMobile() %>" name="mobile" required>
