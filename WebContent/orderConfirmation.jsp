    ...
    <section class="ftco-section">
    	...
    	<div class="container">
    		...
    		<div class="row">
    		    ...
    		    <!--Signup form-->
				<form action="orderConfirmation" method="post" enctype='multipart/form-data' style="border:1px solid #ccc">
  				<div class="container">
				...
				<label for="firstName"><b>Mobile</b></label>
    			<input type="text" placeholder="Enter Phone Number" name="phoneNumber"  required>

    			<label for="lastName"><b>Location</b></label>
    			<input type="text" placeholder="Enter Your Location" name="address"  required>

   				<label for="password"><b>Payment Method</b></label>
    			<select id="" name="paymentMethod">
